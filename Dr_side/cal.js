...
function createModal(eventInfo, date) {
                ...
                <div class="modal-footer">
                    <div class="container">
                        <div class="row" style="padding: 5px;">
                            <button type="button" class="btn btn-warning modal-btn-notify" >
                                <i class='bx bxs-bell-ring' style="margin-right: 5px;"></i>Cancel Appointment
                            </button>
    ...
    $(".modal-btn-notify").on("click",function(){
                   ...
                   <div class="modal-footer">
                       <div class="container">
                           <div style="padding: 5px;" class="d-flex justify-content-end">
                               ...
                               <button type="button" id="deleteappt" class="btn btn-danger" style="margin-left: 5px;">Cancel</button>
                           </div>
                       </div>
                   </div>
               </div>
       ...
       $('#deleteappt').on('click', function () {
           sendNoti(eventInfo, date); // Call the delete function with the appropriate appointment ID
...
function sendNoti(eventInfo, appt_id) {
    ...
    $.ajax({
        url: "../patient/sendCancelNoti.php",
        type: "POST",
