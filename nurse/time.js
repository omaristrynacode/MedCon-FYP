...
if($("#hosp").text()=="American University of Beirut Medical Center"){
  $("#profile-info").css('background-image','url("../img/AUBMChigh.jpg")')
}else if($("#hosp").text()=="Rafik Hariri University Hospital"){
  $("#profile-info").css('background-image','url("../img/rhuh4.jpg")')
}else if($("#hosp").text()=="Hammoud Hospital University Medical Center"){
